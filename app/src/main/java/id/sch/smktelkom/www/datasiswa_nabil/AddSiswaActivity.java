package id.sch.smktelkom.www.datasiswa_nabil;
...
public class AddSiswaActivity extends AppCompatActivity {
    ...
    //untuk class image nya diambil dari class library nguyenHoanglam,        bukan dari androidmedia
    ...
    public void onViewClickedImage() {
        ImagePicker.with(this)
                ...
                .setSelectedImages(imageLibrary).setAlwaysShowDoneButton(true)
